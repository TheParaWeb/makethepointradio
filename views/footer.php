<footer>
    <nav class="medium-7 small-centered columns">
        ...
        <ul class="medium-3 columns center">
            ...
            <li><a href="<?php echo URL;?>blog/" class="disabled">Blog</a></li>
            <li><a href="<?php echo URL;?>contact/">Contact</a></li>
            <li><a href="<?php echo URL;?>advertise/">Advertise with Us</a></li>
        </ul>

        <ul class="medium-3 columns">
            <li><a href="<?php echo URL;?>news/" class="disabled">News</a></li>
            <li><a href="<?php echo URL;?>featured/" class="disabled">Featured</a></li>
        </ul>
